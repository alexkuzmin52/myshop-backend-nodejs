export const config = {
  ...
  START_NUMBER_CATEGORY_ID: process.env.START_NUMBER_CATEGORY_ID || 1000,
  START_NUMBER_SUB_CATEGORY_ID: process.env.START_NUMBER_SUB_CATEGORY_ID || 2000,
  START_NUMBER_SUB_SUB_CATEGORY_ID: process.env.START_NUMBER_SUB_SUB_CATEGORY_ID || 3000,
  START_NUMBER_PRODUCT_ID: process.env.START_NUMBER_PRODUCT_ID || 1
